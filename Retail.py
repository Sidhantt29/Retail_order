 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "fa38bd10-261c-4b36-9cf2-f5f249845c4a",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "003d73ef-c1cb-4f87-aece-d0ccdaa5694c",
   "metadata": {},
   "outputs": [],
   "source": [
    "import numpy as np\n"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "ff523f2a-b9b2-44ae-9dd6-6c059e20aa0d",
   "metadata": {},
   "outputs": [],
   "source": [
    "data=pd.read_csv('C:\\\\Users\\\\bhusa\\\\OneDrive\\\\Desktop\\\\Jupiter Project\\\\orders.csv')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "cb7b36ea-2fbe-4477-9e0b-49866f8e03d7",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "0db773b9-e315-43a2-bda6-2ef36c128237",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "c0d4ea23-dce7-41a4-937d-55005bcf5476",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "e7e5a943-92d6-4ebc-be4c-0a49c3bc588b",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "10438aeb-30b9-4f2b-a6aa-aaa385a66be6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "38748d18-f4b5-4672-a424-ef01bc6509a0",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "4fada1be-7c97-4b19-a611-b61a3401e645",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "29f3fddc-2edf-40d2-adc3-b58a8ba5e932",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "a9d99d83-a2d9-45d6-9950-aa4c220293fb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "5400996d-e0da-412e-87b0-1885e6f58517",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "b4d5539d-4f64-4982-b0e2-42e84836d70c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "28f18028-4d42-4455-a104-cc08be94fca6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "8e392ea1-366f-41c9-8e80-a41349c6a049",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "fc381bc6-cbdb-4d61-9363-3bf637f73cdd",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "9a03755b-5f5c-475f-bb04-68122b25c233",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "0d775f8a-6687-4b42-b476-844862f38a62",
   "metadata": {
    "scrolled": true
   },
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "9993   Appliances  OFF-AP-10002684         210         240         2   \n",
       "\n",
       "      discount_percent  discount  sales_price  \n",
       "0                    2       5.2        254.8  \n",
       "1                    3      21.9        708.1  \n",
       "2                    5       0.5          9.5  \n",
       "3                    2      19.2        940.8  \n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 20,
   "id": "0cce1d4f-28e5-414b-a5b7-e4d2f7438d15",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "58a62ab0-cb36-4170-95ee-582465a6af9f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "21cca94e-8c93-4680-919b-0dcec23cdda0",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 23,
   "id": "088cc5db-7e24-4042-a4c3-ead4232412d2",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "8a5ab790-38e7-471b-b389-ff5b857d3d56",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "506d46e7-6a7a-46e9-849f-0f770ddeb00b",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "3f3320a5-562a-48f7-9dc0-4f89b76b01e1",
   "metadata": {},
   "outputs": [],
   "source": [
    "import warnings"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "2ddd6ca9-e25a-4fa4-9952-3a397af5d765",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "37e2e3a4-2b70-48b9-8ceb-80654a4ff47c",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: SQLAlchemy in c:\\users\\bhusa\\appdata\\local\\programs\\python\\python313\\lib\\site-packages (2.0.36)\n",
      "Requirement already satisfied: typing-extensions>=4.6.0 in c:\\users\\bhusa\\appdata\\local\\programs\\python\\python313\\lib\\site-packages (from SQLAlchemy) (4.12.2)\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 29,
   "id": "185b2241-72d4-434e-95c7-901c14cda0e4",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 30,
   "id": "eefcc4f1-72fc-43be-8dfd-06e5a165d6be",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: pymysql in c:\\users\\bhusa\\appdata\\local\\programs\\python\\python313\\lib\\site-packages (1.1.1)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 31,
   "id": "65f204da-c99d-4156-b6e1-e070f67a0cf4",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pymysql"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 32,
   "id": "3a66ae4a-3f43-4dd2-a8d7-c51006fd2e87",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 42,
   "id": "08a08531-6918-417c-bbf4-b03d468b4a41",
   "metadata": {},
   "outputs": [],
   "source": [
    "engine=create_engine('mysql://root:Thakur%40123@127.0.0.1:3306/data_mysql')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 43,
   "id": "d8b3ca2e-2115-450f-ba67-af7156f691e3",
   "metadata": {},
   "outputs": [],
   "source": [
    "conn = engine.connect()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 45,
   "id": "57ca252a-27c0-468b-8589-abd790e4b4a9",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "data.to_sql('data_orders',con=conn,index=False,if_exists='replace')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "692b23de-163f-43fa-bb20-d659e855b677",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "id": "25ba9b10-1052-400d-ae0a-e0fd8a6a15c2",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8e8879d2-4234-4cd3-a3a1-1a43bdd0f104",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "f15e8c81-daf7-44f8-976d-a17395a97684",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "7949edaf-8bd6-4aa7-a47d-4f0af8331caf",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "74b2ff35-fa6a-4deb-8979-ebeb5fad9e3a",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8ec31510-861d-4b14-901c-c29cc7348010",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "bcdc5d43-931d-4de1-b74d-5861a4a8a488",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "4888fce3-125b-4e77-ae17-a91989b27cca",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "65f5a3b3-0d83-48f5-9078-494a3dc353b5",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "358a7ebb-2095-484f-8249-9563e570583d",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "dabd7af9-450e-4c8b-8952-6df46e31be18",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "67d02955-a088-4c7c-b04e-05aa9b0d801f",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ca2426a9-c017-458c-8dc2-8c16f06588e3",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "9852633e-8691-4fc7-960b-3afc50793c21",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "dc9dccfa-643c-4130-9d2a-bb6d9e3c5e9d",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "9a9fe5ad-4201-40bc-b55a-3ad3f435a899",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "9ceaa92c-0c1f-45d3-bbad-8703769c8517",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "4d9df4ca-f41f-43e6-b038-dacb259428a6",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "a1528647-8cdc-49c0-8294-fb66ea648470",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "bff6fdaa-1cb8-40ad-86e5-b415e9c6acbf",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "f5c8f423-9787-4c37-bdcf-1710f03150eb",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8655ec83-b201-4086-becb-9f46b60694c8",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ffe0ec16-ff44-49a3-87e7-9a1d2c7125cd",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "43c8e6af-6589-4577-b716-4c5065d93113",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ba616f78-2d14-4ab5-b916-aa58a4a5b3fc",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "679e7f78-e127-4307-b9da-ab35c744687c",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "7ae2b2ee-1253-42af-9cfe-e5a82d8217f6",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "5591ab9b-582a-47ed-a7a2-a7e77d0983f4",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "7f821d45-ed1e-486d-98df-193553f19e38",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "233b5f24-97c0-4b37-aa5b-ecb8286b5535",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "d29b90b3-9a88-4a27-a6d3-0bb33dd525bf",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "cb7eb74b-c287-496c-9a1d-8cf6195b7858",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "719279b3-7a0e-4cc4-b66e-829bbff64222",
   "metadata": {},
   "outputs": [],
   "source": []
  }
